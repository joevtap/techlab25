...
export class InitDb1747919198591 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users" ("id" text PRIMARY KEY NOT NULL, "email" text NOT NULL, "username" text NOT NULL, "password_hash" text NOT NULL, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"))`);
        ...
        await queryRunner.query(`CREATE TABLE "transactions" ("id" text PRIMARY KEY NOT NULL, "date" date NOT NULL, "amount" integer NOT NULL, "type" text NOT NULL, "description" text, "source_account" text, "target_account" text)`);
