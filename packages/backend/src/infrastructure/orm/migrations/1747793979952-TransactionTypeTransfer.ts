...
export class TransactionTypeTransfer1747793979952
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."transactions_type_enum" AS ENUM('CREDIT', 'DEBIT', 'TRANSFER')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "transactions" ALTER COLUMN "from_id" DROP NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "transactions" ALTER COLUMN "to_id" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" ALTER COLUMN "from_id" SET NOT NULL`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."transactions_type_enum_old" AS ENUM('CREDIT', 'DEBIT')`,
    );
    await queryRunner.query(
